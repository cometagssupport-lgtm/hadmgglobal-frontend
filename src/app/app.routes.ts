    ...
    children: [
      {
        ...
        children: [
          ...
          { path: 'plans', component: Rewards },
          { path: 'profile', component: Profile },
        ]
      },
      { path: 'activation-complete', component: RewardsSuccess },
      { path: 'withdraw', component: Withdrawal },
      { path: 'history', component: History },
      { path: 'transactions', component: TransactionHistory },
      { path: 'earnings', component: Commision },
      ...
      { path: 'billing', component: DepositOxapay },
      { path: 'wallet', component: Deposit },
      { path: 'completed', component: Success },
      ...
      { path: 'network', component: Referral },
      { path: 'community', component: Telegram },
    ]
  },
