  ...
  rewardsList: any = [
    {
      ...
      paragraph: 'Successfully inviting 5 direct subordinates to recharge 50 USDT to get a 30 USDT reward.',
      requiredInvites: 5,
      currentInvites: 0,
      rewardAmount: 20,
    ...
    },
    {
      ...
      paragraph: 'Successfully inviting 15 direct subordinates to recharge 50 USDT to get a 100 USDT reward.',
      requiredInvites: 15,
      currentInvites: 0,
      rewardAmount: 30,
      buttonName: 'Claim Now',
    ...
    },
    {
      ...
      paragraph: 'Successfully inviting 30 direct subordinates to recharge 50 USDT to get a 180 USDT reward.',
      requiredInvites: 30,
      currentInvites: 0,
      rewardAmount: 50,
      buttonName: 'Claim Now',
    ...
    this.authService.avengers(payload).subscribe({
      next: (res: any) => {
        if (res.statusCode === 200) {
          this.router.navigate(['/activation-complete']);
        } else {
